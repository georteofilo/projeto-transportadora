<?PHP
    ...
    if (isset($_POST['editarFuncionario']) && isset($_REQUEST['editarFuncionario'])){
    ...
    $userTabela = new Funcionario();
    $mostrar = $userTabela->mostrarFuncionario($pdo);
...
<body>
    <div class="container-inicial">
        ...
        <main class="principal-funcionarios">
            ...
            <div id="funcionario-editar" class="funcionario-editar">
                    <div class="box-editar">
                        <a class="btn-fechar-form" href="funcionarios.php">
                            <img id="icon-fechar" src="../assents/img/icon-fechar.svg">
                        </a>
                        <h2 class="editar-header">Editar Funcionário</h2>
                        <form method="post" class="form-editar"  enctype="multipart/form-data">
                            ...
                            <div class="form-body">
                                <div class="form-pessoal">
                                    ...
                                    <div class="form-cpf">
                                        ...
                                        <input type="text" name="cpf" id="cpf" value="<?php echo $user['cpf']?>" required>
                                    </div>
                                    <div class="form-dataNasc">
                                        <label for="dataNasc">Data de Nascimento:</label>
                                        <input type="date" name="dataNasc" value="<?php echo $user['dataNasc']?>" >
                                    </div>
                                    <div class="form-tel">
                            ...
                            <div class="editar-footer">
                                <input id="btn-editar" class="btn-editar" type="submit" value="Editar" name="editarFuncionario">
                                <a class="btn-voltar" href="funcionarios.php">Voltar</a>
                            </div>
                        </form>
                    </div>
                </div>
