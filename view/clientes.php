<?PHP
    ...
    $cliente = new Cliente();
    $mostrar = $cliente->mostrarCliente($pdo);
    ...
    <div class="container-inicial">
        ...
        <main class="principal-clientes">
            <header class="header-clientes">
                ...
                <div class="clientes-btn-cadastrar" id="clientes-abrir-cadastro">
                    <img src="../assents/img/icon-add-clientes.svg" alt="">
                    <span>Cadastrar</span>
                </div>
                <div id="cliente-cadastro" class="cliente-cadastro">
                    <div class="box-cadastro">
                        <button class="btn-fechar-form" id="btn-fechar-form">
                            <img id="icon-fechar" src="../assents/img/icon-fechar.svg" alt="">
                        </button>
                        <h2 class="cadastro-header">Cadastrar Cliente</h2>
                        <form method="post" class="form-cadastro"  enctype="multipart/form-data">
                            ...
                            <div class="cadastro-footer">
                                <input class="btn-cadastrar" type="submit" value="Cadastrar" name="cadastrarCliente">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class='btn-editar-fornecedores'>
                                                <a href='../view/editar_clientes.php?id=".$linha['idCliente']."')\">
                                        ...
                                        <td>
                                            <div class='btn-deletar-fornecedores'>
                                                <a href='../controller/deletar_cliente.php?id=".$linha['idCliente']."'onClick=\"return confirm('Tem certeza que deseja excluir o usuário ".$linha['nome']."?')\">
