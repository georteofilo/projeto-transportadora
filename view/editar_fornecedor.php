<?PHP
    ...
    $id = $_GET['id'];
    if(!empty($id)){
        $user = Fornecedor::pesquisarFornecedor($pdo, $id);
    }

    if (isset($_POST['editarFornecedor']) && isset($_REQUEST['editarFornecedor'])){

        $fornecedor = new Fornecedor($_POST);
        $fornecedor->editarFornecedor($pdo, $id);
    ...
    $userTabela = new Fornecedor();
    $mostrar = $userTabela->mostrarFornecedor($pdo);
...
<body>
    <div class="container-inicial">
        ...
        <main class="principal-fornecedores">
                    ...
                    <tbody>
                        <?php
                            foreach($mostrar as $linha){
                                echo "
                                    <tr>
                                        <td>".$linha['idFornecedores']."</td>
                                        <td>".$linha['nome']."</td>
                                        <td>".$linha['email']."</td>
                                        <td>".$linha['cpf']."</td>
                                        <td>".$linha['dataNasc']."</td>
                                        <td>".$linha['telefone']."</td>
                                        <td><img src='../assents/fotos/fornecedores/".$linha['fotoNome']."'></td>
                                        <td>
                                            <div class='btn-abrir-editar' id='fornecedores-abrir-editar'>
                                                <form method='post'>
                                                    <button type='submit' name='editarFornecedores'>
                                        ...
                                        <td>
                                            <div class='btn-deletar' id='fornecedores-deletar'>
                                                <form method='post'>
                                                    <button type='submit' name='deletarFornecedores'>
            ...
            <div id="fornecedor-editar" class="fornecedor-editar">
                    <div class="box-editar">
                        <a class="btn-fechar-form" href="fornecedores.php">
                            <img id="icon-fechar" src="../assents/img/icon-fechar.svg">
                        </a>
                        <h2 class="editar-header">Editar Fornecedor</h2>
                        <form method="post" class="form-editar"  enctype="multipart/form-data">
                            ...
                            <div class="editar-footer">
                                <input id="btn-editar" class="btn-editar" type="submit" value="Editar" name="editarFornecedor">
                                <a class="btn-voltar" href="fornecedores.php">Voltar</a>
                            </div>
                        </form>
                    </div>
                </div>
